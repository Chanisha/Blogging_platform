  ...
  try {
    ...
    const newPost = await db
      ...
      .values({
        ...
        // category: category?.trim() || null, // Temporarily commented out until schema is fixed
  ...
  try {
    ...
    let query = db
      .select({
        ...
        // category: posts.category, // Temporarily commented out until schema is fixed
        author: {
          id: users.id,
